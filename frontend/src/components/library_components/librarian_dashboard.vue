<template>
    <div :class="[isDarkMode?'dark':'main-class']">
        ...
        <div class="main-content">
           ...
           <h2 :class="[isDarkMode?'h2dark':'h2light']">{{monitor_status}}</h2>
           <div class="d-flex">
             <label for="" class="me-5"><h2>Go to Section Page</h2></label>
             <a href="/section_page"><button class="btn btn-primary">Section Page</button></a>
           </div>
        </div>
